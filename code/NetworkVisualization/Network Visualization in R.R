...
# Presenter: Patrick Chester
# Date: 4/20/2026
# Credit: Katherine (Katya) Ognyanova's Sunbelt Workshop (GitHub: kateto)


# ================ Introduction ================ 


# Download the workshop materials: bit.ly/sunbelt-2024
# Online tutorial: kateto.net/sunbelt2024
...
# Download an archive with the data files from http://bit.ly/sunbelt-2024
...
samp_graph <- graph_from_edgelist(sample_graph)


# Above is a simple network. Assume that each node is a worker at a firm and each link is an email between them. 
# I want you to do the following
# 1. Customize the node and edge color.
# 2. Calculate the degree of each node
# 3. Change the size of the node to reflect their degree
...
# Given the news network used in the prior exercise:
# 1. Assign a specific layout among the options provided above
# 2. Color nodes based on a categorical aspect, using your own color scheme
# 3. Set a minimum link threshold 
...
# Customize the news graph from the prior exercise using the ggraph model
# 1. Customize the node color based on node characteristics
# 2. Change node size based on audience size
